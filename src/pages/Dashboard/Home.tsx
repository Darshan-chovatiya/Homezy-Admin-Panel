...
import ServicePartnerPerformance from "../../components/analytics/ServicePartnerPerformance";
      ...
      <div className="space-y-6">
        ...
        <div className="border-b border-gray-200 dark:border-gray-700">
          <nav className="-mb-px flex space-x-8">
            ...
            <button
              onClick={() => setActiveTab("customer-retention")}
              className={`py-2 px-1 border-b-2 font-medium text-sm ${
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  disabled={loading}
                  className="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3 py-1 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                >
                  {loading ? (
        ...
        {activeTab === "customer-retention" && (
          <CustomerRetention period={selectedPeriod} />
        )}

        {activeTab === "service-partners" && (
          <ServicePartnerPerformance period={selectedPeriod} />
        )}
      </div>
    </>
  );
